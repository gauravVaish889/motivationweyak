<?php
namespace EDCARE_CORE_ELEMENTOR\Templates;

defined('ABSPATH') || die();

class EDCARE_CORE_Templates
{
    private static $instance = null;

    public static function url(){
        if (defined('EDCARE_CORE_ADDONS_FILE_')) {
            $file = trailingslashit(plugin_dir_url( EDCARE_CORE_ADDONS_FILE_ )). 'include/elementor/templates/';
        } else {
    ...
    public static function dir(){
        if (defined('EDCARE_CORE_ADDONS_FILE_')) {
            $file = trailingslashit(plugin_dir_path( EDCARE_CORE_ADDONS_FILE_ )). 'include/elementor/templates/';
        } else {
    ...
    public static function version(){
        if( defined('EDCARE_CORE_ADDONS_VERSION_') ){
            return EDCARE_CORE_ADDONS_VERSION_;
        } else {
    ...
    public function init()
    {
        ...
        add_action( 'elementor/editor/after_enqueue_scripts', function() {
            ...
            $localize_data = [
                ...
                'templateLogo'                    => EDCARE_CORE_EXT_LOGO_ICON_URL,
                'i18n' => [
        ...
        add_action( 'elementor/preview/enqueue_styles', function(){
            $data = '.elementor-add-new-section .EDCARE_CORE_Templates_add_button {
    ...
    public static function get_tabs(){
        return apply_filters('tp_editor/templates_tabs', [
            'section' => [ 'title' => 'EdCare Sections'],
            'page' => [ 'title' => 'EdCare Pages'],
        ]);
    }

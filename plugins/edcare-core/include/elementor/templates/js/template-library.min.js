!function($, $ele, $i) {
    ...
    $app.Manager = function() {
        ...
        function addButton() {
            ...
            }), $sl.find(".EDCARE_CORE_Templates_add_button").length || $sl.find(TP_FIND_SELECTOR).before($tpOpenLibraryButton)
        }

        function initAddButton($el) {
            var $t = $el.find(TP_FIND_SELECTOR);
            $t.length && !$el.find(".EDCARE_CORE_Templates_add_button").length && $t.before($tpOpenLibraryButton), $el.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", addButton)
        }
        ...
        function onEditorLoaded() {
            var $el = window.elementor.$previewContents,
                ...
                $el.on("click.onAddTemplateButton", ".EDCARE_CORE_Templates_add_button", $this.showModal.bind($this)), this.channels.tabs.on("change:device", onChanges)
        }
            ...
            $previewContents.on('click', '.elementor-editor-element-add', function() {
                ...
                setTimeout(function() {
                    ...
                    $previewContents.find('.elementor-add-section').each(function(){
                        if($(this).find('.EDCARE_CORE_Templates_add_button').length == 0){
        ...
        $tpOpenLibraryButton = '<div class="elementor-add-section-area-button EDCARE_CORE_Templates_add_button"> <img src="'+tpcoreEditor.templateLogo+'" /> </div>', 
        $tpResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"

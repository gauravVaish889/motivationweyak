 ...
 * @since 1.0.0
 */
class EdCare_Course_Slider extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Course Slider', 'edcare-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Button Text', 'edcare-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Explore All Courses', 'edcare-core' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-carousel-top .swiper-arrow .swiper-nav' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-carousel-top .swiper-arrow .swiper-nav' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-carousel-top .swiper-arrow .swiper-nav' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-carousel-top .swiper-arrow .swiper-nav:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-carousel-top .swiper-arrow .swiper-nav:hover' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .course-carousel-top .swiper-arrow .swiper-nav:hover' => 'border-color: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        ?>
            ...
            <?php if ( $settings['design_style']  == 'layout-1' ) : 
                ...
                <section class="edcare-el-section course-carousel-area pt-120 pb-120 overflow-hidden">
                    <div class="bg-img" data-background="assets/img/new-update/shapes/course-bg-img.png"></div>
                    <div class="container">
...
$widgets_manager->register( new EdCare_Course_Slider() );
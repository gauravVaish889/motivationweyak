 ...
 * @since 1.0.0
 */
class EdCare_Header_04 extends Widget_Base
{
    ...
    {
        return __(EDCARE_CORE_THEME_NAME . ' :: Header 4', 'edcare-core');
    }
    ...
    protected function register_controls_section()
    {
        ...
        $this->add_control(
            'header_top_countdown_title',
            [
                'label' => esc_html__( 'Title', 'text-domain' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Admission Going On, Hurry To Enroll Now', 'text-domain' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'countdown_date',
            [
                'label' => __('Countdown Date', 'plugin-domain'),
                'type' => Controls_Manager::DATE_TIME,
                'default' => date('Y-m-d H:i:s', strtotime('+7 days')),
                'description' => __('Set the target date and time for the countdown.', 'plugin-domain'),
            ]
        );
    ...
    protected function style_tab_content()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .header-4 .top-bar .top-bar-inner' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-4 .top-bar .top-bar-inner .top-bar-left p' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .header-4 .top-bar .top-bar-inner .top-bar-left p',
            ]
        );

        $this->add_control(
            '_heading_style_header_top_time',
            [
        ...
        $this->add_control(
            'header_top_time_color',
            [
                'label' => esc_html__( 'Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-4 .top-bar .top-bar-inner .top-bar-left .rr-product-countdown .rr-product-countdown-inner ul li span' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .header-4 .top-bar .top-bar-inner .top-bar-left .rr-product-countdown .rr-product-countdown-inner ul li' => 'color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'header_top_time_background',
            [
                'label' => esc_html__( 'Background', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-4 .top-bar .top-bar-inner .top-bar-left .rr-product-countdown .rr-product-countdown-inner' => 'background-color: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        ?>
            ...
            <header class="header header-2 header-4 <?php echo esc_attr($is_sticky); ?> <?php echo esc_attr($edit_class); ?>">
                <div class="top-bar">
                    <div class="container">
                        <div class="top-bar-inner">
                            <div class="top-bar-left white-content">
                                <?php if ( !empty( $settings['header_top_countdown_title'] ) ) : ?>
                                    <p class="mb-0">
                                        <?php print edcare_kses($settings['header_top_countdown_title']); ?><span></span>
                                    </p>
                                <?php endif; ?>
                                <div class="rr-product-countdown" data-countdown data-date="<?php print esc_attr($settings['countdown_date']); ?>">
                                    ...
                                    <div class="header-right">
                                        ...
                                        <?php if (!empty($settings['edcare_theme_btn_text'])): ?>
                                            <a <?php echo $this->get_render_attribute_string('edcare-button-arg' . $btn_id . ''); ?>>
                                                <?php echo edcare_kses($settings['edcare_theme_btn_text']); ?> <i class="fa-sharp fa-regular fa-arrow-right"></i>
                                            </a>
                                        <?php endif; ?>
...
$widgets_manager->register(new EdCare_Header_04());

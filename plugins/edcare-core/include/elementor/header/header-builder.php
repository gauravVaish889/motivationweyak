 ...
 * @since 1.0.0
 */
class EdCare_Header_01 extends Widget_Base
{
    ...
    {
        return __(EDCARE_CORE_THEME_NAME . ' :: Header 1', 'edcare-core');
    }
    ...
    protected function register_controls_section()
    {
        ...
        $this->add_control(
            'edcare_header_search_switch',
            [
                'label' => esc_html__('Header Search Switch', 'edcare-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'edcare-core'),
                'label_off' => esc_html__('Hide', 'edcare-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 125,
                'selectors' => [
                    '{{WRAPPER}} .header-logo img' => 'width: {{VALUE}}px;',
                ],
            ]
        );
        ...
        if (!empty($menus)) {
            $this->add_control(
                'cat_menu',
                [
                    'label' => __('Category One', 'edcare-core'),
                    'type' => Controls_Manager::SELECT,
                    'options' => $menus,
                    'default' => array_keys($menus)[0],
                    'save_default' => true,
        ...
        if (!empty($menus)) {
            $this->add_control(
                'cat_menu_two',
                [
                    'label' => __('Category Two', 'edcare-core'),
                    'type' => Controls_Manager::SELECT,
                    'options' => $menus,
                    'default' => array_keys($menus)[0],
                    'save_default' => true,
    ...
    protected function style_tab_content()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header-1 .primary-header' => 'border-color: {{VALUE}}',
                    '{{WRAPPER}} .header-1 .primary-header .primary-header-inner .header-menu-wrap' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .mid-header-right .header-right-icon a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .mid-header-right .header-right-icon a' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .header .mid-header .mid-header-inner .mid-header-right .header-right-icon a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .mid-header-right .header-right-icon .number' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .mid-header-right .header-right-icon .number' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            '_style_category_one',
            [
                'label' => esc_html__( 'Category One',  'text-domain'  ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->start_controls_tabs( 'category_one_list_tabs' );

        $this->start_controls_tab(
            'category_one_list_normal_tab',
            [
                'label' => esc_html__( 'Normal', 'text-domain' ),
            ]
        );
        ...
        $this->add_control(
            'category_one_list_color',
            [
                'label' => esc_html__( 'Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .select-control' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'category_one_list_color_hover',
            [
                'label' => esc_html__( 'Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .select-control a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            '_heading_style_category_button',
            [
        ...
        $this->start_controls_tabs( 'category_one_button_tabs' );

        $this->start_controls_tab(
            'category_one_button_normal_tab',
            [
                'label' => esc_html__( 'Normal', 'text-domain' ),
            ]
        );
        ...
        $this->add_control(
            'category_one_button_color',
            [
                'label' => esc_html__( 'Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .header-form .submit' => 'color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'category_one_button_background',
            [
                'label' => esc_html__( 'Background', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .header-form .submit' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'category_one_button_color_hover',
            [
                'label' => esc_html__( 'Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .header-form .submit:hover' => 'color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'category_one_button_background_hover',
            [
                'label' => esc_html__( 'Background', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .header-form .submit:before' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'category_one_button_typography',
                'selector' => '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .header-form .submit i, .header .mid-header .mid-header-inner .category-form-wrap .header-form .submit',
            ]
        );

        $this->add_control(
            '_heading_style_category_layout',
            [
        ...
        $this->add_control(
            'category_one_background',
            [
                'label' => esc_html__( 'Background', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .select-control' => 'background-color: {{VALUE}}',
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .header-form .form-control' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'category_one_border',
                'selector' => '{{WRAPPER}} .nice-select .list',
            ]
        );

        $this->add_responsive_control(
            'category_one_border_radius',
            [
                'label' => esc_html__( 'Border Radius', 'text-domain' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .nice-select .list' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'category_one_padding',
            [
                'label' => esc_html__( 'Padding', 'text-domain' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .nice-select .list' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'category_one_background_list',
            [
                'label' => esc_html__( 'List Background', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'category_one_arrow_color',
            [
                'label' => esc_html__( 'Arrow Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .select-control:after' => 'border-color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'category_one_separator_border_color',
            [
                'label' => esc_html__( 'Border Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .header .mid-header .mid-header-inner .category-form-wrap .select-control' => 'border-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            '_style_category_two',
            [
                'label' => esc_html__( 'Category Two',  'text-domain'  ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_control(
            '_heading_style_category_two_title',
            [
        ...
        $this->add_responsive_control(
            'category_two_icon_size',
            [
                'label' => esc_html__( 'Icon Size', 'text-domain' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-btn i' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_control(
            'category_two_icon_color',
            [
                'label' => esc_html__( 'Icon Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-btn i' => 'color: {{VALUE}}',
                ],
            ]
        );

        $this->add_control(
            'category_two_text_color',
            [
                'label' => esc_html__( 'Text Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-btn span' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'name' => 'category_two_text_typography',
                'selector' => '{{WRAPPER}} .category-area .category-btn span',
            ]
        );

        $this->start_controls_tabs( 'category_two_list_tabs' );

        $this->start_controls_tab(
            'category_two_list_normal_tab',
            [
                'label' => esc_html__( 'Normal', 'text-domain' ),
            ]
        );
        ...
        $this->add_control(
            'category_two_list_color',
            [
                'label' => esc_html__( 'Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-sub-menu li a' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'category_two_list_color_hover',
            [
                'label' => esc_html__( 'Color', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-sub-menu li a:hover' => 'color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            '_heading_style_category_two_layout',
            [
                'label' => esc_html__( 'Layout', 'text-domain' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
        ...
        $this->add_control(
            'category_two_background_list',
            [
                'label' => esc_html__( 'List Background', 'text-domain' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-sub-menu' => 'background-color: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            Group_Control_Border::get_type(),
            [
                'name' => 'category_two_border',
                'selector' => '{{WRAPPER}} .category-area .category-sub-menu',
            ]
        );

        $this->add_responsive_control(
            'category_two_border_radius',
            [
                'label' => esc_html__( 'Border Radius', 'text-domain' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-sub-menu' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'category_two_padding',
            [
                'label' => esc_html__( 'Padding', 'text-domain' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
                    '{{WRAPPER}} .category-area .category-sub-menu' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        if (!empty($settings['cat_menu'])):
            $cat_menu = $settings['cat_menu'];
        else:
            $cat_menu = '';
        endif;
        ...
        $cat_args = [
            'echo' => false,
            'menu' => $cat_menu,
            'menu_class' => 'edcare-cat-menu list',
            'menu_id' => 'menu-' . $this->get_nav_menu_index() . '-' . $this->get_id(),
            'fallback_cb' => 'edcare_Navwalker_Class::fallback',
            'container' => '',
            'walker' => new edcare_Navwalker_Class,
        ...
        $cat_menu_html = wp_nav_menu($cat_args);

        if (!empty($settings['cat_menu_two'])):
            $cat_menu_two = $settings['cat_menu_two'];
        else:
            $cat_menu_two = '';
        endif;
        ...
        $cat_two_args = [
            'echo' => false,
            'menu' => $cat_menu_two,
            'menu_class' => 'edcare-cat-menu category-sub-menu list',
            'menu_id' => 'menu-' . $this->get_nav_menu_index() . '-' . $this->get_id(),
            'fallback_cb' => 'edcare_Navwalker_Class::fallback',
            'container' => '',
            'walker' => new edcare_Navwalker_Class,
        ...
        $cat_menu_two_html = wp_nav_menu($cat_two_args);
        ...
        <!-- header-area-start -->
        <header class="header header-1 header-3 <?php echo esc_attr($is_sticky); ?> <?php echo esc_attr($edit_class); ?>">
            ...
            <div class="mid-header">
                <div class="container">
                    <div class="mid-header-inner">
                        ...
                        <?php if ( !empty( $settings['edcare_header_search_switch'] ) ) : ?>
                            <div class="category-form-wrap">
                                <div class="nice-select select-control country" tabindex="0">
                                    <span class="current">Categories</span>
                                    <?php print $cat_menu_html; ?>
                                </div>
                                <form class="header-form" role="search" method="get" action="<?php echo esc_url( home_url( '/shop' ) ); ?>">
                                    <input class="form-control" type="text" name="s" placeholder="<?php echo esc_attr__( 'Search here...', 'edcare-core' ); ?>" value="<?php echo get_search_query(); ?>">
                                    <input type="hidden" name="post_type" value="product">
                                    <button class="submit ed-primary-btn" type="submit">
                                        <i class="fa-regular fa-magnifying-glass"></i> <?php echo esc_html__( 'Search', 'edcare-core' ); ?>
                                    </button>
                                </form>
                            </div>
                        <?php endif; ?>
...
$widgets_manager->register(new EdCare_Header_01());

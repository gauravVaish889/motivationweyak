 ...
 * @since 1.0.0
 */
class EdCare_Header_02 extends Widget_Base
{
    ...
    {
        return __(EDCARE_CORE_THEME_NAME . ' :: Header 2', 'edcare-core');
    }
    ...
    protected function render()
    {
        ...
        <header class="header header-2 <?php echo esc_attr($is_sticky); ?> <?php echo esc_attr($edit_class); ?>">
...
$widgets_manager->register(new EdCare_Header_02());

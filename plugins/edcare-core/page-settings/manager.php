<?php
namespace EdCareCore\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'edcare-core' ) );
	}

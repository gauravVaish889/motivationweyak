...
$edcare_search_btn = get_theme_mod( 'edcare_blog_btn', 'Read More' );
$edcare_search_btn_switch = get_theme_mod( 'edcare_blog_btn_switch', true );

?>


<?php if ( !empty( $edcare_search_btn_switch ) ): ?>
<div class="tp-blog-grid-btn">
    <a href="<?php the_permalink();?>" class="tp-link-btn-3">
        <?php print esc_html( $edcare_search_btn );?>
        <span>

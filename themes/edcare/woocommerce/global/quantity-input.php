...
if ($max_value && $min_value === $max_value) {
	...
	$label = !empty($args['product_name']) ? sprintf(esc_html__('%s quantity', 'edcare'), wp_strip_all_tags($args['product_name'])) : esc_html__('Quantity s', 'edcare');
	?>
	<div class="tp-shop-details-quantity">
		<div class="quantity">
			...
			<input type="text" id="<?php echo esc_attr($input_id); ?>"
				...
				title="<?php echo esc_attr_x('Qty', 'Product quantity input tooltip', 'edcare'); ?>" size="4"

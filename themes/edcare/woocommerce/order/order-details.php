...
<div class="woocommerce-order-details">
	...
	<h4 class="woocommerce-order-details__title tp-order-info-title"><?php esc_html_e( 'Order details', 'edcare' ); ?></h4>
	...
	<div class="tp-order-info-list">
		<ul>
			...
			<li class="tp-order-info-list-header">
				<h4><?php esc_html_e( 'Product', 'edcare' ); ?></h4>
				<h4><?php esc_html_e( 'Total', 'edcare' ); ?></h4>
			</li>
			...
			<?php foreach ( $order->get_order_item_totals() as $key => $total ) :
				...
				<li class="<?php echo esc_attr($class); ?>">
					...
					<span><?php echo edcare_kses( $total['value'] ); ?></span>
				</li>
			<?php endforeach; ?>

			<?php if ( $order->get_customer_note() ) : ?>
				<li class="tp-order-info-list-note">
					<span><?php esc_html_e( 'Note:', 'edcare' ); ?></span>
					<p><?php echo edcare_kses( nl2br( wptexturize( $order->get_customer_note() ) ) ); ?></p>
				</li>
			<?php endif; ?>

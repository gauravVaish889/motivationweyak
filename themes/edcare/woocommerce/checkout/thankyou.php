...
<?php
	  ...
	  <div class="tp-order-bg"></div>
	   <div class="row gx-0 align-items-center">
		   <?php if ( $order->has_status( 'failed' ) ) : ?>
			  ...
			  <div class="col-xl-12">
				  <p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed"><?php esc_html_e( 'Unfortunately your order cannot be processed as the originating bank/merchant has declined your transaction. Please attempt your purchase again.', 'edcare' ); ?></p>
	  
				  <p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed-actions">
					  <a href="<?php echo esc_url( $order->get_checkout_payment_url() ); ?>" class="button pay"><?php esc_html_e( 'Pay', 'edcare' ); ?></a>
					  <?php if ( is_user_logged_in() ) : ?>
						  <a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>" class="button pay"><?php esc_html_e( 'My account', 'edcare' ); ?></a>
					  <?php endif; ?>
				  </p>
			  </div>
			 ...
			 <div class="tp-order-details">
				<div class="tp-order-details-top text-center mb-70">
				   ...
				   <div class="tp-order-details-content">
					  <h3 class="tp-order-details-title"><?php echo esc_html__('Your Order Confirmed', 'edcare'); ?></h3>
					  <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', wp_kses_post( 'We will send you a shipping confirmation email as soon <br> as your order ships ', 'edcare' ), $order ); ?></p>
				   </div>
				</div>
				   ...
				   <div class="row">
					  <div class="col-sm-5">
						 <div class=" tp-order-details-item">
							<h4><?php echo esc_html__('Order Date:', 'edcare'); ?></h4>
					  ...
					  <div class="col-sm-7">
						 <div class="woocommerce-order-overview__date date tp-order-details-item">
							<h4><?php echo esc_html__( 'Email:', 'edcare' ); ?></h4>
					  ...
					  <div class="col-sm-5">
						 <div class="woocommerce-order-overview__order order tp-order-details-item">
							<h4><?php echo esc_html__('Order Number:', 'edcare'); ?></h4>
							<p><?php echo esc_html__('#', 'edcare');  echo esc_html($order->get_order_number());?></p>
						 </div>
					  </div>
					  <?php endif; ?>
					  ...
					  <div class="col-sm-7">
						 <div class="woocommerce-order-overview__payment-method method tp-order-details-item">
							<h4><?php echo esc_html__('Payment Method:', 'edcare'); ?></h4>
   ...
   <?php else : ?>
	...
	<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'edcare' ), null ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>

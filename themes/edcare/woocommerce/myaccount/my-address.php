...
if (!wc_ship_to_billing_address_only() && wc_shipping_enabled()) {
	$get_addresses = apply_filters(
		...
		array(
			'billing' => __('Billing address', 'edcare'),
			'shipping' => __('Shipping address', 'edcare'),
		),
		$customer_id
	);
} else {
...
<div class="profile__tab-content">
	<p class="tp-woo-myaccount-address-msg woocommerce-message">
		<?php echo apply_filters('woocommerce_my_account_my_address_description', esc_html__('The following addresses will be used on the checkout page by default.', 'edcare')); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
	</p>
					...
					<div class="profile__address-content">
						...
						<div class="profile__address-header d-sm-flex align-items-center ">
							...
							<a href="<?php echo esc_url(wc_get_endpoint_url('edit-address', 'billing')); ?>"
								class="edit"><?php echo array_key_exists('billing', $get_addresses) ? esc_html__('Edit', 'edcare') : esc_html__('Add', 'edcare'); ?></a>
						</div>
						...
						<?php if (!empty($billing_address)): ?>
							...
							<!-- phone -->
							<?php if ($phone): ?>
								<p><span><?php esc_html_e('Phone number:', 'edcare'); ?></span><?php echo esc_html($phone); ?>
								</p>
							<?php endif; ?>
							<!-- street -->
							<?php if ($company): ?>
							...
							<!-- state -->
							<?php if ($state): ?>
								<p><span><?php esc_html_e('State/province/area:', 'edcare'); ?></span><?php echo esc_html($state); ?>
								</p>
							<?php endif; ?>
							<!-- zip code -->
							<?php if ($postcode): ?>
								<p><span><?php esc_html_e('Zip code:', 'edcare'); ?></span><?php echo esc_html($postcode); ?>
								</p>
							<?php endif; ?>
							<!-- country -->
							<?php if ($country): ?>
					...
					<div class="profile__address-content">
						<div class="profile__address-header d-sm-flex align-items-center">
							...
							<a href="<?php echo esc_url(wc_get_endpoint_url('edit-address', 'shipping')); ?>"
								class="edit"><?php echo array_key_exists('shipping', $get_addresses) ? esc_html__('Edit', 'edcare') : esc_html__('Add', 'edcare'); ?></a>
						</div>

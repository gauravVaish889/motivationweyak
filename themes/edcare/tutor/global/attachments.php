					...
					<div class="tutor-card-body">
						<div class="tutor-row">
							<div class="tutor-col tutor-overflow-hidden">
								...
								<div class="tutor-fs-7 tutor-color-muted"><?php esc_html_e( 'Size', 'edcare' ); ?>: <?php echo esc_html( $attachment->size ); ?></div>
							</div>
...
<?php else :
	tutor_utils()->tutor_empty_state( __( 'No Attachment Found', 'edcare' ) );
endif;

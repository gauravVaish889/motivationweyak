...
$show_more = false;
$short_by = array(
	'relevant' => __('Relevant', 'edcare'),
	'new' => __('New', 'edcare'),
	'popular' => __('Popular', 'edcare'),
);
...
?>>
	<div class="tutor-row">
		<aside class="tutor-col-lg-3 tutor-mb-32 tutor-mb-lg-0" tutor-instructors-filters>
			<div class="tutor-d-flex tutor-align-center">
				<div>
					...
					<span
						class="tutor-fs-5 tutor-fw-medium tutor-color-black"><?php esc_html_e('Filters', 'edcare'); ?></span>
				</div>
				...
				<div class="tutor-ml-32">
					<a href="#" class="tutor-btn tutor-btn-ghost" tutor-instructors-filter-clear>
						...
						<span class="tutor-fw-medium"><?php esc_html_e('Clear', 'edcare'); ?></span>
					</a>
				</div>
			</div>
			...
			<div class="tutor-widget tutor-widget-course-categories tutor-mt-48">
				...
				<div class="tutor-widget-content">
					<div class="<?php echo esc_attr($show_more ? 'tutor-toggle-more-content tutor-toggle-more-collapsed' : ''); ?>"
						<?php echo esc_attr($show_more ? ' data-tutor-toggle-more-content data-toggle-height="200" style="height: 200px;"' : ''); ?>>
						<div class="tutor-list" tutor-instructors-filter-category>
							<?php foreach ($categories as $category): ?>
								<div class="tutor-list-item">
									<label>
										<input id="tutor-instructor-checkbox-<?php echo esc_attr($category->term_id); ?>"
											type="checkbox" class="tutor-form-check-input" name="category"
				...
				<div class="tutor-widget-content">
					<div class="tutor-ratings tutor-ratings-lg tutor-ratings-selectable">
						<div class="tutor-ratings-stars">
							<?php for ($i = 1; $i < 6; $i++): ?>
								<i class="tutor-icon-star-line" tutor-instructors-filter-rating
									data-value="<?php echo esc_attr($i); ?>" area-hidden="true"></i>
							<?php endfor; ?>
						</div>
						<span class="tutor-ratings-count tutor-instructor-rating-filter"
							tutor-instructors-filter-rating-count></span>
					</div>
				</div>
			</div>
		</aside>
		...
		<main class="tutor-col-lg-9 tutor-col-xl-<?php echo esc_attr($columns < 3 ? 8 : 9); ?>">
			<div class="tutor-form-wrap tutor-mb-24">
				<span class="tutor-icon-search tutor-form-icon" area-hidden="true"></span>
				<input type="text" class="tutor-form-control" name="keyword"
					placeholder="<?php esc_attr_e('Search any instructor...', 'edcare'); ?>"
					tutor-instructors-filter-search />
			</div>
			...
			<div tutor-instructors-content>
				<?php echo edcare_kses($content);//phpcs:ignore ?>
			</div>
		</main>
	</div>
</div>
...
<form method="post" class="tutor-reset-password-form tutor-ResetPassword lost_reset_password pt-120 pb-70">
	...
	<p>
		...
		echo esc_html(
			apply_filters(
				...
				esc_html__( 'Enter Password and Confirm Password to reset your password', 'edcare' )
			)
		);
		?>
	</p>
	...
	<div class="tutor-form-row">
		<div class="tutor-form-col-12">
			<div class="tutor-form-group">
				<label><?php esc_html_e( 'Confirm Password', 'edcare' ); ?></label>

...
<div class="tutor-card tutor-course-card">
		...
		<a href="<?php the_permalink(); ?>" class="tutor-d-block">
			<div class="tutor-ratio tutor-ratio-16x9">
				<img class="tutor-card-image-top"
					src="<?php echo empty($tutor_course_img) ? esc_url($placeholder_img) : esc_url($tutor_course_img); ?>"
	...
	<div class="tutor-card-body">
		...
		<div class="tutor-meta tutor-mt-auto">
			...
			<div>
				<?php esc_html_e('By', 'edcare'); ?>
				<a href="<?php echo esc_url($profile_url); ?>"
					target="_parent"><?php echo esc_html(get_the_author()); ?></a>

				<?php if (!empty($course_categories) && is_array($course_categories) && count($course_categories)): ?>
					<?php esc_html_e('In', 'edcare'); ?>
					<?php
	...
	<div class="tutor-card-footer">
		<a href="<?php the_permalink(); ?>" class="tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block "
			target="_parent">
			<?php esc_html_e('View Details', 'edcare'); ?>
		</a>
	</div>
</div>
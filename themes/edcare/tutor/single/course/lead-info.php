				...
				<div class="tutor-meta tutor-course-details-info"> 
					...
					<div>
						...
						<?php if ( ! empty( $course_categories ) && is_array( $course_categories ) && count( $course_categories ) ) : ?>
							<?php esc_html_e( 'Categories:', 'edcare' ); ?>
							<?php
							...
							?>
						<?php else : ?>
							<?php esc_html_e( 'Uncategorized', 'edcare' ); ?>
						<?php endif; ?>
					</div>
				</div>
			</div>
			...
			<div class="tutor-col-auto">
				<div class="tutor-course-details-actions tutor-mt-12 tutor-mt-sm-0">
					<a href="#" class="tutor-btn tutor-btn-ghost tutor-course-wishlist-btn tutor-mr-16" data-course-id="<?php echo get_the_ID(); ?>">
						<i class="<?php echo esc_attr($is_wish_listed ? 'tutor-icon-bookmark-bold' : 'tutor-icon-bookmark-line'); ?> tutor-mr-8"></i> <?php esc_html_e( 'Wishlist', 'edcare' ); ?>
					</a>

...
if ( ! count( $questions ) ) : ?>
	<div class="tutor-empty-state-wrapper">
		<div class="tutor-empty-state td-empty-state tutor-p-32 tutor-text-center">
			<img src="<?php echo esc_url( tutor()->url . 'assets/images/empty-qa.svg' ); ?>" alt="<?php __( 'No Data Available in this Section', 'edcare' ); ?>" width="85%">
			<div class="tutor-fs-6 tutor-color-secondary tutor-text-center tutor-mt-20">
				<?php esc_html_e( 'No questions yet', 'edcare' ); ?>
			</div>
			<div class="tutor-fs-7 tutor-color-muted tutor-mt-12">
				<?php esc_html_e( "Describe what you're trying to achieve and where you're getting stuck", 'edcare' ); ?>
			</div>
		</div>
	</div>
	<?php

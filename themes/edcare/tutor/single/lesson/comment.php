...
<div class="tutor-pagination-wrapper-replaceable tutor-single-course-lesson-comments tutor-pb-32"
	data-lesson_id="<?php echo esc_attr($lesson_id); ?>">
	<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-36">
		<?php esc_html_e('Join the conversation', 'edcare'); ?>
	</div>
	<div class="tutor-conversation tutor-pb-20 tutor-pb-sm-48">
		<form class="tutor-comment-box" method="post">
			...
			<div class="tutor-comment-textarea">
				<textarea placeholder="<?php esc_attr_e('Write your comment here…', 'edcare'); ?>"
					class="tutor-form-control" name="comment"></textarea>
	...
	<div class="tutor-button-wrapper tutor-mt-12 tutor-d-flex tutor-justify-end">
		<?php
		echo edcare_kses($load_more_btn); // phpcs:ignore
		?>
	</div>
</div>
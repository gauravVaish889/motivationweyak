...
<?php if (is_array($comments) && count($comments)): ?>
	...
	foreach ($comments as $comment):
		...
		<div class="tutor-comments-list tutor-parent-comment tutor-mt-32"
			id="lesson-comment-<?php echo esc_attr($comment->comment_ID); ?>">
			...
			<div class="tutor-single-comment">
				<div class="tutor-actual-comment tutor-mb-12">
					<div class="tutor-comment-author">
						...
						<span class="tutor-fs-7 tutor-ml-12 tutor-ml-sm-10">
							<?php echo esc_html(human_time_diff(strtotime($comment->comment_date), tutor_time()) . __(' ago', 'edcare')); ?>
						</span>
					</div>
				...
				<div class="tutor-comment-actions tutor-ml-24">
					<span class="tutor-fs-6 tutor-color-secondary"><?php esc_html_e('Reply', 'edcare'); ?></span>
				</div>
								...
								<div class="tutor-actual-comment tutor-mb-12">
									<div class="tutor-comment-author">
										...
										<span class="tutor-fs-7 tutor-ml-0 tutor-ml-sm-10">
											<?php echo esc_html(human_time_diff(strtotime($reply->comment_date), tutor_time()) . __(' ago', 'edcare')); ?>
										</span>
									</div>
									<div class="tutor-comment-text tutor-fs-6 tutor-mt-4">
				...
				<form class="tutor-comment-box tutor-reply-box tutor-mt-20" method="post" tutor-comment-reply>
					...
					<div class="tutor-comment-textarea">
						<textarea placeholder="<?php esc_attr_e('Write your comment here…', 'edcare'); ?>" name="comment"

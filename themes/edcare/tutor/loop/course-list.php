...
<div class="col">
    <div class="tp-course-filter-item mb-25 d-flex align-items-stretch">
        ...
        <div class="tp-course-filter-content position-relative">
            ...
            <div class="tp-course-filter-tag mb-10">
                <span class="tag-span" data-cat-color="<?php echo esc_attr($cat_color); ?>"><a href="<?php echo get_term_link($course_categories[0]); ?>"><?php echo esc_html($course_categories[0]->name); ?></a></span>
            </div>
            <?php endif; ?>
            ...
            <div class="tp-course-filter-meta d-flex align-items-center gap-2">
                <span>
            ...
            <div class="tp-course-list-p">
                <p> <?php if(is_archive()){echo get_the_excerpt();}; ?> </p>
            </div>
            ...
            <div class="tp-course-filter-pricing d-flex align-items-center justify-content-between">
                ...
                <span class="edcare-course-list-card-price"><?php echo edcare_kses($price); ?></span>
            </div>
        </div>
    </div>
</div>
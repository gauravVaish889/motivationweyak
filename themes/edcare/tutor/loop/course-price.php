...
$enroll_btn = '<div class="tutor-course-list-btn">' . apply_filters( 'tutor_course_restrict_new_entry', '<a href="' . get_the_permalink() . '" class="tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block ' . $button_class . ' " data-course-id="' . $course_id . '">' . __( 'Enroll Course', 'edcare' ) . '</a>' ) . '</div>';
	...
	if ( 0 != $maximum_students && $total_enrolled != $maximum_students ) {
		...
		echo '<div class="tutor-d-flex tutor-align-center tutor-justify-between">
                    ...
                    <div class="tutor-course-booking-progress tutor-d-flex tutor-align-center">
						...
						esc_html( $b_total ) . __( '% Booked', 'edcare' ) . '
                        </div>
                    </div>
                </div>

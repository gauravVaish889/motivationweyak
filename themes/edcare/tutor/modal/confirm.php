...
$yes = isset($yes) ? $yes : array('text' => __('Yes', 'edcare'));
			...
			<div class="tutor-modal-body tutor-text-center">
				<div class="tutor-px-lg-48 tutor-py-lg-24">
					<?php if ($image): ?>
						<div class="tutor-mt-24">
							<img class="tutor-d-inline-block"
								src="<?php echo esc_url(tutor()->url); ?>assets/images/<?php echo esc_attr($image); ?>" />
						</div>
					<?php endif; ?>

					<?php if ($icon): ?>
						<div class="tutor-mt-24">
							<span class="tutor-d-inline-block"><?php echo esc_html($icon); ?></span>
						</div>
					<?php endif; ?>
					...
					<div class="tutor-d-flex tutor-justify-center tutor-mt-48 tutor-mb-24">
						...
						<button
							class="tutor-btn tutor-btn-primary<?php echo isset($yes['class']) ? ' ' . esc_html($yes['class']) : ''; ?> tutor-ml-20"
							<?php echo isset($yes['attr']) && is_array($yes['attr']) ? implode(' ', $yes['attr']) : ''; //phpcs:ignore ?>>

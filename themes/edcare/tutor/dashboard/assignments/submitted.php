...
$deadline       = tutor_utils()->get_assignment_deadline_date( $assignment_id, $format, __( 'No Limit', 'edcare' ) );
...
<div class="tutor-dashboard-content-inner tutor-dashboard-assignment-submits">
	...
	<div class="tutor-assignment-review-header tutor-assignment-submitted-page">
		<div class="tutor-fs-7 tutor-color-secondary">
			<?php esc_html_e( 'Course', 'edcare' ); ?> : <?php echo esc_html( get_the_title( $comment_parent ) ); ?>
		</div>
		...
		<div class="assignment-info tutor-mt-12 tutor-d-flex">
			<div class="tutor-fs-7 tutor-color-secondary">
				<?php esc_html_e( 'Submission Deadline', 'edcare' ); ?>:
	...
	<div class="tutor-dashboard-announcement-sorting-wrap submitted-assignments-sorting-wrap">
		<div class="tutor-dashboard-announcement-sorting-input">
			<label class="tutor-fs-7 tutor-color-secondary"><?php esc_html_e( 'Sort By:', 'edcare' ); ?></label>
			<select class="tutor-announcement-order-sorting tutor-form-control">
				<option value="desc" <?php selected( $order_filter, 'desc' ); ?>><?php esc_html_e( 'Latest', 'edcare' ); ?></option>
				<option value="asc" <?php selected( $order_filter, 'asc' ); ?>><?php esc_html_e( 'Oldest', 'edcare' ); ?></option>
			</select>
		</div>
	</div>
	...
	<?php else : ?>
		<?php tutor_utils()->tutor_empty_state( 'No assignment', 'edcare' ); ?>
	<?php endif; ?>
</div>

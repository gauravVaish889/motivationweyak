...
if (!$assignment_submitted_id) {
	tutor_utils()->tutor_empty_state(__("Sorry, but you are looking for something that isn't here.", 'edcare'));
	return;
}

$submitted_assignment = tutor_utils()->get_assignment_submit_info($assignment_submitted_id);
if (!$submitted_assignment) {
	tutor_utils()->tutor_empty_state(__('Assignments submission not found or not completed', 'edcare'));
	return;
}
?>
...
<div class="tutor-dashboard-content-inner tutor-dashboard-assignment-review">
	...
	<div class="submitted-assignment-title tutor-mb-16">
		<a class="tutor-btn tutor-btn-ghost"
			href="<?php echo esc_url($submitted_url . '?assignment=' . $assignment_id); ?>">
	...
	<div class="tutor-assignment-review-header">
		<div class="tutor-row tutor-align-center tutor-mb-16">
			<div class="tutor-col-lg-3">
				<span class="tutor-color-secondary"><?php esc_html_e('Course', 'edcare'); ?>:</span>
			</div>
			<div class="tutor-col-lg tutor-mt-8 tutor-mt-lg-0">
				<a class="tutor-fw-medium tutor-color-black"
					href="<?php echo esc_url(get_the_permalink($submitted_assignment->comment_parent)); ?>"
					target="_blank">
		...
		<div class="tutor-row tutor-align-center tutor-mb-16">
			<div class="tutor-col-lg-3">
				<span class="tutor-color-secondary"><?php esc_html_e('Student', 'edcare'); ?>:</span>
			</div>
			<div class="tutor-col-lg tutor-mt-8 tutor-mt-lg-0">
				<span
					class="tutor-fw-medium tutor-color-black"><?php echo esc_html($comment_author->display_name . ' (' . $comment_author->user_email . ')'); ?></span>
			</div>
		</div>

		<div class="tutor-row tutor-align-center">
			<div class="tutor-col-lg-3">
				<span class="tutor-color-secondary"><?php esc_html_e('Submitted Date', 'edcare'); ?>:</span>
			</div>
			<div class="tutor-col-lg tutor-mt-8 tutor-mt-lg-0">
				<span
					class="tutor-fw-medium tutor-color-black"><?php echo esc_html(tutor_utils()->convert_date_into_wp_timezone($submitted_assignment->comment_date_gmt, 'j M, Y, h:i a')); ?></span>
			</div>
		</div>
	</div>
	...
	<div class="tutor-dashboard-assignment-submitted-content tutor-mt-32 tutor-mb-16">
		<h5 class="tutor-fs-6 tutor-fw-medium tutor-mb-4">
			<?php esc_html_e('Assignment Description:', 'edcare'); ?>
		</h5>
		...
		if ($attached_files && is_array(json_decode($attached_files))):
			...
			<div class="tutor-fs-5 tutor-fw-medium tutor-mb-20">
				<?php esc_html_e('Attach assignment file(s)', 'edcare'); ?>
			</div>
						...
						if (tutor_utils()->count($attached_files)) {
							...
							foreach ($attached_files as $attached_file) {
								...
								<div class="tutor-col-lg-6 tutor-mb-16 tutor-mb-lg-0">
									<div
										class="tutor-card tutor-d-flex tutor-align-center tutor-px-16 tutor-py-12 tutor-mb-12 tutor-flex-row">
										<div>
											<div class="tutor-fs-6 tutor-color-black tutor-mb-4">
												<?php echo esc_html(tutor_utils()->array_get('name', $attached_file)); ?></div>
											<div class="tutor-fs-7 tutor-color-muted"><?php esc_html_e('Size', 'edcare'); ?>:
										...
										<div class="tutor-ml-auto">
											<a href="<?php echo esc_url($upload_baseurl . tutor_utils()->array_get('uploaded_path', $attached_file)); ?>"
												class="tutor-iconic-btn tutor-iconic-btn-secondary tutor-iconic-btn-lg" target="_blank"
	...
	<div class="tutor-dashboard-assignment-review-area tutor-mt-32">
		<h3><?php esc_html_e('Evaluation', 'edcare'); ?></h3>
		<form action="" method="post" class="tutor-row tutor-form-submit-through-ajax"
			data-toast_success_message="<?php esc_attr_e('Assignment evaluated', 'edcare'); ?>">
			<?php wp_nonce_field(tutor()->nonce_action, tutor()->nonce); ?>
			<input type="hidden" value="tutor_evaluate_assignment_submission" name="tutor_action" />
			<input type="hidden" value="<?php echo esc_html($assignment_submitted_id); ?>"
				name="assignment_submitted_id" />

			<div class="tutor-col-12 tutor-col-sm-4 tutor-col-md-12 tutor-col-lg-3">
				<label for=""><?php esc_html_e('Your Points', 'edcare'); ?></label>
			</div>
			<div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-9 tutor-mb-32">
				<input type="number" class="tutor-form-control" name="evaluate_assignment[assignment_mark]"
					value="<?php echo esc_attr($given_mark ? $given_mark : 0); ?>" min="0"
					max="<?php echo esc_attr($max_mark); ?>"
					title="<?php esc_attr_e('Evaluate mark can not be greater than total mark', 'edcare'); ?>">
				<p class="desc">
					<?php
					/* translators: %s: max mark */
					echo sprintf(__('Evaluate this assignment out of %s', 'edcare'), "<code>{$max_mark}</code>");//phpcs:ignore 
					?>
				</p>
			</div>

			<div class="tutor-col-12 tutor-col-sm-4 tutor-col-md-12 tutor-col-lg-3">
				<label for=""><?php esc_html_e('Feedback', 'edcare'); ?></label>
			</div>
			...
			<div class="tutor-col-12 tutor-col-sm-8 tutor-col-md-12 tutor-col-lg-9">
				<button type="submit" class="tutor-btn tutor-btn-primary tutor-mt-16">
					<?php esc_html_e('Evaluate this submission', 'edcare'); ?>
				</button>
			</div>
		</form>
	</div>

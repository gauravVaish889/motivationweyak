...
<div class="tutor-dashboard tpd-setting-box profile">
	<div class="tutor-dashboard-content p-0">
		...
		<div id="tutor_profile_cover_photo_editor">
			...
			<div id="tutor_cover_area" data-fallback="<?php echo esc_attr( $cover_placeholder ); ?>" style="background-image:url(<?php echo esc_url( $cover_photo_src ); ?>)">
				...
				<div class="tutor_overlay">
					<button class="tutor_cover_uploader tutor-btn tutor-btn-primary">
						...
						<span><?php echo esc_html($profile_photo_id ? esc_html__( 'Update Cover Photo', 'edcare' ) : esc_html__( 'Upload Cover Photo', 'edcare' )); ?></span>
					</button>
				</div>
			</div>
			<div id="tutor_photo_meta_area">
				<img src="<?php echo esc_url( tutor()->url . '/assets/images/' ); ?>info-icon.svg" />
				<span><?php esc_html_e( 'Profile Photo Size', 'edcare' ); ?>: <span><?php esc_html_e( '200x200', 'edcare' ); ?></span> <?php esc_html_e( 'pixels', 'edcare' ); ?></span>
				<span>&nbsp;&nbsp;&nbsp;&nbsp;<?php esc_html_e( 'Cover Photo Size', 'edcare' ); ?>: <span><?php esc_html_e( '700x430', 'edcare' ); ?></span> <?php esc_html_e( 'pixels', 'edcare' ); ?> </span>
				<span class="loader-area"><?php esc_html_e( 'Saving...', 'edcare' ); ?></span>
			</div>
			...
			<div id="tutor_pp_option">
				...
				<span class="tutor_pp_uploader profile-uploader">
					<i class="profile-upload-icon tutor-icon-image-landscape tutor-mr-4"></i> <?php esc_html_e( 'Upload Photo', 'edcare' ); ?>
				</span>
				<span class="tutor_pp_deleter profile-uploader">
					<i class="profile-upload-icon tutor-icon-trash-can-bold tutor-mr-4"></i> <?php esc_html_e( 'Delete', 'edcare' ); ?>
				</span>
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="tutor-row">
					<div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
						...
						<input class="tutor-form-control" type="text" name="first_name" value="<?php echo esc_attr( $user->first_name ); ?>" placeholder="<?php esc_attr_e( 'First Name', 'edcare' ); ?>">
					</div>
					...
					<div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
						...
						<input class="tutor-form-control" type="text" name="last_name" value="<?php echo esc_attr( $user->last_name ); ?>" placeholder="<?php esc_attr_e( 'Last Name', 'edcare' ); ?>">
					</div>
				</div>
				...
				<div class="tutor-row">
					...
					<div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
						<label class="tutor-form-label tutor-color-secondary">
							<?php esc_html_e( 'Phone Number', 'edcare' ); ?>
						</label>
						<input class="tutor-form-control" type="tel" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" name="phone_number" value="<?php echo esc_html( filter_var( get_user_meta( $user->ID, 'phone_number', true ), FILTER_SANITIZE_NUMBER_INT ) ); ?>" placeholder="<?php esc_attr_e( 'Phone Number', 'edcare' ); ?>">
					</div>
				</div>
				...
				<div class="tutor-row">
					<div class="tutor-col-12 tutor-mb-32">
						<label class="tutor-form-label tutor-color-secondary">
							<?php esc_html_e( 'Skill/Occupation', 'edcare' ); ?>
						</label>
						<input class="tutor-form-control" type="text" name="tutor_profile_job_title" value="<?php echo esc_attr( get_user_meta( $user->ID, '_tutor_profile_job_title', true ) ); ?>" placeholder="<?php esc_attr_e( 'UX Designer', 'edcare' ); ?>">
					</div>
				</div>
				...
				<div class="tutor-row">
					<div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
						<label class="tutor-form-label tutor-color-secondary">
							<?php esc_html_e( 'Display name publicly as', 'edcare' ); ?>
						...
						<div class="tutor-fs-7 tutor-color-secondary tutor-mt-12">
							<?php esc_html_e( 'The display name is shown in all public fields, such as the author name, instructor name, student name, and name that will be printed on the certificate.', 'edcare' ); ?>
						</div>
					</div>
				</div>
				...
				<div class="tutor-row">
					<div class="tutor-col-12">
						<div class="tpd-setting-cartificate-btn">
							<button type="submit" class="tutor-profile-settings-save"><?php esc_html_e( 'Update Profile', 'edcare' ); ?></button>
						</div>
					</div>
				</div>
			</form>

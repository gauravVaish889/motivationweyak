	...
	<div class="tutor-modal-content tutor-announcement-modal-content">
		<div class="modal-header">
			<div class="modal-title">
				<h1><?php esc_html_e( 'Update Announcement', 'edcare' ); ?></h1>
			</div>
		...
		<div class="tutor-modal-container">
			<form action="" class="tutor-announcements-update-form">
				...
				<div class="tutor-form-group">
					...
					<input type="text" name="tutor_announcement_title" id="tutor-announcement-title" value="" placeholder="<?php esc_attr_e( 'Announcement title', 'edcare' ); ?>" required>
				</div>
				<div class="tutor-form-group">
					<label for="tutor_announcement_course">
						<?php esc_html_e( 'Summary', 'edcare' ); ?>
					</label>
					<textarea rows="6" type="text" id="tutor-announcement-summary" name="tutor_announcement_summary" value="" placeholder="<?php echo esc_attr__( 'Summary...', 'edcare' ); ?>" required></textarea>
				</div>
				...
				<div class="modal-footer">
					<button type="submit" class="tutor-btn"><?php esc_html_e( 'Update', 'edcare' ); ?></button>
					<button type="button" class="quiz-modal-tab-navigation-btn  quiz-modal-btn-cancel tutor-announcement-close-btn tutor-announcement-cancel-btn "><?php esc_html_e( 'Cancel', 'edcare' ); ?></button>
				</div>
			</form>
		</div>
	</div>

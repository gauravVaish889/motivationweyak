			...
			<div class="tutor-detail-course-content">
				...
				<div class="tutor-detail-course-info-wrap">
					<div class="tutor-announcement-detail-course-info">
						<label for=""><?php esc_html_e( 'Course', 'edcare' ); ?></label>
						<p></p>
					</div>
					<div class="tutor-announcement-detail-date-info">
						<label for=""><?php esc_html_e( 'Publish Date', 'edcare' ); ?></label>
						<p></p>
					</div>
				</div>
				<div class="tutor-announce-detail-popup-button-wrap">
					...
					<div class="announcement-detail-edit-delete-button">
						<button class="tutor-btn tutor-announcement-delete tutor-border-none" id="tutor-announcement-delete-from-detail"><?php esc_html_e( 'Delete', 'edcare' ); ?></button>
						<button class="tutor-btn tutor-border-none tutor-announcement-edit" id="tutor-announcement-edit-from-detail"><?php esc_html_e( 'Edit', 'edcare' ); ?></button>
					</div>
				</div>
			</div>
		</div>

...
<div class="tutor-row">
	...
	<div class="tutor-col-xs-6 tutor-col-md-3 tutor-mt-lg-0">
		<label class="tutor-form-label tutor-d-block tutor-mb-10"><?php esc_html_e( 'Sort By', 'edcare' ); ?></label>
	...
	<div class="tutor-col-xs-6 tutor-col-md-3 tutor-mt-lg-0">
		<label class="tutor-form-label tutor-d-block tutor-mb-10"><?php esc_html_e( 'Create Date', 'edcare' ); ?></label>

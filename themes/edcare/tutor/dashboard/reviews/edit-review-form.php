	...
	<div class="tutor-write-review-box tutor-star-rating-container">
		...
		<div class="tutor-form-group">
			<textarea name="review"
				placeholder="<?php esc_attr_e('write a review', 'edcare'); ?>"><?php echo wp_kses_post(stripslashes(esc_textarea($rating->review))); ?></textarea>
		</div>
		<div class="tutor-form-group">
			<button type="submit"
				class="tutor-button tutor-button-primary"><?php esc_html_e('Update Review', 'edcare'); ?></button>
		</div>
	</div>
</form>
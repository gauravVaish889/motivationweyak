...
<div class="tutor-fs-5 tutor-fw-medium tutor-color-black tutor-mb-24"><?php esc_html_e( 'Assignment', 'edcare' ); ?></div>
...
<div class="tutor-dashboard-content-inner tutor-dashboard-assignments">
	<div class="tutor-row tutor-mb-24">
		...
		<div class="tutor-col-6 tutor-col-lg-3">
			<label class="tutor-form-label"><?php esc_html_e( 'Sort By', 'edcare' ); ?></label>
		...
		<div class="tutor-col-6 tutor-col-lg-3">
			<label class="tutor-form-label"><?php esc_html_e( 'Create Date', 'edcare' ); ?></label>
		...
		<div class="tutor-table-responsive">
			<table class="tutor-table table-assignment">
				<thead>
					<tr>
						<th>
							<?php esc_html_e( 'Assignment Name', 'edcare' ); ?>
						</th>
						<th>
							<span class="tutor-fs-7"><?php esc_html_e( 'Total Marks', 'edcare' ); ?></span>
						</th>
						<th>
							<span class="tutor-fs-7"><?php esc_html_e( 'Total Submit', 'edcare' ); ?></span>
						</th>
						<th></th>
					</tr>
				</thead>
						...
						<tr>
							...
							<?php echo esc_html( $item->post_title ); ?>
								<div class="tutor-fs-7 tutor-mt-8">
									<span class="tutor-fw-medium"><?php esc_html_e( 'Course', 'edcare' ); ?>: </span>

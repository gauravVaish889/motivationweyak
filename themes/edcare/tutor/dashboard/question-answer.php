	...
	<div class="tutor-row tutor-mb-24">
		<div class="tutor-col">
			<div class="tutor-fs-5 tutor-fw-medium tutor-color-black">
				<?php esc_html_e( 'Question & Answer', 'edcare' ); ?>
			</div>
		</div>
		...
		<?php if ( $is_instructor ) : ?>
			<div class="tutor-col-auto">
				<label class="tutor-form-toggle tutor-dashboard-qna-vew-as tutor-d-flex tutor-justify-end current-view-<?php echo 'instructor' == $view_as ? 'instructor' : 'student'; ?>">
					...
					<span class="tutor-form-toggle-label tutor-form-toggle-<?php echo 'student' == $view_as ? 'checked' : 'unchecked'; ?>"><?php esc_html_e( 'Student', 'edcare' ); ?></span>
					<span class="tutor-form-toggle-control"></span>
					<span class="tutor-form-toggle-label tutor-form-toggle-<?php echo 'instructor' == $view_as ? 'checked' : 'unchecked'; ?>"><?php esc_html_e( 'Instructor', 'edcare' ); ?></span>
				</label>
			</div>
		<?php endif; ?>
	</div>
		...
		<div class="tutor-row">
			<div class="tutor-col-lg-5">
				<div class="tutor-qna-filter tutor-d-flex tutor-align-center">
					<span class="tutor-fs-7 tutor-color-secondary tutor-mr-20"><?php esc_html_e( 'Sort By', 'edcare' ); ?>:</span>

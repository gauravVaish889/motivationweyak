...
?>
<div class="tutor-thumbnail-uploader tutor-mt-12" data-media-heading="<?php echo ! empty( $media_heading ) ? esc_attr( $media_heading ) : esc_attr__( 'Select or Upload Media Of Your Chosen Persuasion', 'edcare' ); ?>" data-button-text="<?php echo esc_html( ! empty( $button_text ) ? $button_text : __( 'Use this media', 'edcare' ) ); ?>">
	<div class="thumbnail-wrapper tutor-d-flex tutor-align-center <?php echo esc_attr($is_borderless ? 'tutor-is-borderless' : 'tutor-p-16'); ?>">
		...
		<div class="thumbnail-input">
			<div class="tutor-fs-6 tutor-color-secondary">
				...
				<?php else : ?>
					<?php esc_html_e( 'Size: ', 'edcare' ); ?>
					<span class="tutor-fs-7 tutor-fw-medium">
						<?php esc_html_e( '700x430 pixels', 'edcare' ); ?>
					</span>
				<?php endif; ?>
				<br />
				...
				<?php else : ?>
					<?php esc_html_e( 'File Support: ', 'edcare' ); ?>
					<span class="tutor-fs-7 tutor-fw-medium">
						<?php esc_html_x( 'jpg, .jpeg,. gif, or .png', 'tutor-supported-image-type', 'edcare' ); ?>
					</span>
				<?php endif; ?>
			</div>
			...
			<button type="button" class="tutor-btn tutor-btn-primary tutor-btn-sm tutor-mt-16 tutor-thumbnail-upload-button">
				...
				<span><?php esc_html_e( 'Upload Image', 'edcare' ); ?></span>
			</button>
		</div>
	</div>
</div>

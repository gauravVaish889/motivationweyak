		...
		<ul>
			<li>
				<div class="tpd-quiz-time-item">
					<p>
						<span><?php esc_html_e( 'Student:', 'edcare' ); ?></span> <?php echo esc_html( $student_name ); ?>
					</p>
				</div>
			</li>
			<li>
				<div class="tpd-quiz-time-item">
					<p>
						<span><?php esc_html_e( 'Quiz Time:', 'edcare' ); ?></span> <?php echo esc_html( $quiz_time ); ?>
					</p>
				</div>
			</li>
			<li>
				<div class="tpd-quiz-time-item">
					<p>
						<span><?php esc_html_e( 'Attempt Time:', 'edcare' ); ?></span> <?php echo esc_html( $attempt_time ); ?>
					</p>
				</div>
			</li>
		</ul>
